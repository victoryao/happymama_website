          ...
          <div class="row">
            ...
            <div class="col-md-7">
              <div class="gt_who_we_wrap default_width">
                <h5>Who We Are</h5>
                <h3>About EduSkill</h3>
                <span class="gt_hdg_left"></span>
                <p>Diet and health, human osteology,paleopathology  epidemiology, human evolution, disease ecology human adaptation, Diet and health, human osteology,paleopathology  epidemiology, human evolution, disease ecol`ogy human adaptation, an evolution, disease ecology human adaptation, Stable.Diet and health, humanDiet and health,</p>
                <ul class="row">
                  <li class="col-md-6 col-sm-6">
                    <div class="gt_who_we_icon"><i class="icon-education-1"></i></div>
                    <div class="gt_who_we_des">
                      <h6><a href="#">GRADUATED STEPS</a></h6>
                      <p>Diet  edidhal Pidemiology, human</p>
                    </div>
                  </li>
                  <li class="col-md-6 col-sm-6">
                    <div class="gt_who_we_icon"><i class="icon-draw"></i></div>
                    <div class="gt_who_we_des">
                      <h6><a href="#">DRAWING LESSONS</a></h6>
                      <p>Diet  edidhal Pidemiology, human</p>
                    </div>
                  </li>
                  <li class="col-md-6 col-sm-6">
                  ...
                  <li class="col-md-6 col-sm-6">
                    ...
                    <div class="gt_who_we_des">
                      <h6><a href="#">GLOBAL INTERESTED</a></h6>
                      <p>Diet  edidhal Pidemiology, human</p>
                    </div>
                  </li>
                  <li class="col-md-6 col-sm-6">
                    ...
                    <div class="gt_who_we_des">
                      <h6><a href="#">SKILLED FACULTY</a></h6>
                      <p>Diet  edidhal Pidemiology, human</p>
                    </div>
                  </li>
                  <li class="col-md-6 col-sm-6">
                    ...
                    <div class="gt_who_we_des">
                      <h6><a href="#">ONLINE TRAINING</a></h6>
                      <p>Diet  edidhal Pidemiology, human</p>
                    </div>
                  </li>
                </ul>
      ...
      <section class="gt_campus_bg">
        <div class="container">
          ...
          <div class="gt_history_pagination flexslider" id="gt_history_pagination">
            <ul class="slides">
              <li><div class="gt_history_date">1999</div></li>
              <li><div class="gt_history_date">2004</div></li>
              <li><div class="gt_history_date">2007</div></li>
              <li><div class="gt_history_date">2011</div></li>
              <li><div class="gt_history_date">2011</div></li>
            </ul>
          </div>
              ...
              <div class="accor_outer_wrap">
                <div class="ct_accord_list">
                    ...
                    <div class="accord_des">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex commodo consequat. Duis aute irure dolor.</p>
                    </div>
                  </div>
                  <div class="ct_accord_list">
              ...
              <div class="gt_core_value_wrap gt_heading_2">
                    <ul data-tabs="tabs">
                      <li class="active"><a data-toggle="tab" href="#quality">Mission</a></li>
                        ...
                        <li><a data-toggle="tab" href="#success">Activities</a></li>
                    </ul>
                </div>
                <div class="tab-content">
                  <div class="tab-pane active" id="quality">
                    <div class="gt_core_value_tab">
                        <div class="gt_core_value_des">
                            <figure>
                                <img src="extra-images/mission.jpg" alt="">
                            </figure>
                            <div class="gt_core_img_des">
                                <p>This is Photoshop's version of Lorem Ipsum. Proin grav da nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum.</p>
                            </div>
                        </div>
                        <p>This is Photoshop's version of Lorem Ipsum. Proin grav da nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate.</p>
                    </div>
                  </div>
                  ...
                  <div class="tab-pane" id="commitment">
                    <div class="gt_core_value_tab">
                        <div class="gt_core_value_des">
                            <figure>
                                <img src="extra-images/vission.jpg" alt="">
                            </figure>
                            <div class="gt_core_img_des">
